...
/**
 * Servlet suppression d'un Câble
 * 
 * @author Valentin Millot
 */
@WebServlet(name = "DeleteCable", urlPatterns = {"/DeleteCable"})
public class DeleteCable extends HttpServlet {
    ...
    private class Cable{
        ...
        private Cable(String token, String name, String Test){
            this.token = token;
            this.name = name;
            this.Test = Test;
        }
    ...
    /**
     * Suppression d'un Câble à partir de son nom<br><br>
     *
     * Variables à envoyer au servlet (POST)<br>
     * String name       &emsp;&emsp;        nom du câble à supprimer <br>
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DeleteCable.Cable Cable = gsonRequest.fromJson(reader, DeleteCable.Cable.class);
        ...
        try { 
            ...
            if(NameExist == true){
                ...
                if(userRights.equals("Admin")){
                    ...
                    DAO.DeleteCable(name, TestBoolean);
