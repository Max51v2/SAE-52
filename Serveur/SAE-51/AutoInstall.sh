...
sudo cp /home/$USER/Bureau/SAE-52/Serveur/SAE-52/Config/postgresql.conf /etc/postgresql/$postgreSQLVersion/main/postgresql.conf
sudo cp /home/$USER/Bureau/SAE-52/Serveur/SAE-52/Config/pg_hba.conf /etc/postgresql/$postgreSQLVersion/main/pg_hba.conf
...
sudo cp /home/$USER/Bureau/SAE-52/Serveur/SAE-52/Config/gmao.conf gmao.conf
...
sudo cp /home/$USER/Bureau/SAE-52/Serveur/SAE-52/Config/tomcat.service /etc/systemd/system/tomcat.service
sed -i 's/\[VERSION JDK\]/'$Java_version'/g' /etc/systemd/system/tomcat.service
sudo ufw allow 8080
sudo ufw allow 8443
sudo cp /home/$USER/Bureau/SAE-52/Serveur/SAE-52/Config/tomcat-users.xml /opt/tomcat/conf/tomcat-users.xml
cd /certs
clear
...
sudo cp /home/$USER/Bureau/SAE-52/Serveur/SAE-52/Config/Tomcat.xml /opt/tomcat/conf/server.xml
...
[Service]
ExecStart=/bin/bash /home/$USER/Bureau/SAE-52/Serveur/SAE-51/AutoInstall.sh
Restart=on-failure
